...
typedef enum c_legalized_seq_kind {
    ...
    C_LEGALIZED_SEQ_LIST_F64_INDEX,
    C_LEGALIZED_SEQ_LIST_F64_SLICE,
    C_LEGALIZED_SEQ_LIST_F64_LEN,
    C_LEGALIZED_SEQ_LIST_VALUE_INDEX,
    C_LEGALIZED_SEQ_LIST_VALUE_SLICE,
    C_LEGALIZED_SEQ_LIST_VALUE_LEN,
