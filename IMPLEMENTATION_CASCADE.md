...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 44-51
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 31-49
...
Start from IMPLEMENTATION_CHECKLIST.md lines 44-51.
Then read IMPLEMENTATION_ROADMAP.md lines 31-49.
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 52-68
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 50-81
...
```text
Implement M1 (Lexer).
Start from IMPLEMENTATION_CHECKLIST.md lines 52-68.
Then read IMPLEMENTATION_ROADMAP.md lines 50-81.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 69-89
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 82-119
3. Map: `compiler/frontend/ast/AST_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 69-89.
Then read IMPLEMENTATION_ROADMAP.md lines 82-119.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
- compiler/project/PROJECT_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 90-107
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 120-152
...
Start from IMPLEMENTATION_CHECKLIST.md lines 90-107.
Then read IMPLEMENTATION_ROADMAP.md lines 120-152.
Then open these maps:
- compiler/project/PROJECT_MAP.md
- compiler/semantic/binder/BINDER_MAP.md
- compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 108-130
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 153-189
...
Start from IMPLEMENTATION_CHECKLIST.md lines 108-130.
Then read IMPLEMENTATION_ROADMAP.md lines 153-189.
Then open these maps:
- compiler/semantic/binder/BINDER_MAP.md
- compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md
- compiler/semantic/types/TYPE_SYSTEM_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 131-145
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 190-217
3. Map: `compiler/frontend/ast/AST_MAP.md`
4. Map: `compiler/frontend/parser/PARSER_MAP.md`
...
```text
Implement M5 (HIR).
Start from IMPLEMENTATION_CHECKLIST.md lines 131-145.
Then read IMPLEMENTATION_ROADMAP.md lines 190-217.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 146-164
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 218-252
3. Map: `compiler/frontend/ast/AST_MAP.md`
4. Map: `compiler/frontend/parser/PARSER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 146-164.
Then read IMPLEMENTATION_ROADMAP.md lines 218-252.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
- compiler/zir/ZIR_MODEL_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 165-177
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 253-279
3. Map: `compiler/semantic/binder/BINDER_MAP.md`
4. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
5. Map: `compiler/semantic/types/TYPE_SYSTEM_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 165-177.
Then read IMPLEMENTATION_ROADMAP.md lines 253-279.
Then open these maps:
- compiler/semantic/binder/BINDER_MAP.md
- compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md
- compiler/semantic/types/TYPE_SYSTEM_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 178-194
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 280-307
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 178-194.
Then read IMPLEMENTATION_ROADMAP.md lines 280-307.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 195-203
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 308-335
3. Map: `compiler/driver/DRIVER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 195-203.
Then read IMPLEMENTATION_ROADMAP.md lines 308-335.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/project/PROJECT_MAP.md
- compiler/zir/ZIR_MODEL_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 204-226
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 336-375
3. Map: `compiler/frontend/ast/AST_MAP.md`
4. Map: `compiler/frontend/parser/PARSER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 204-226.
Then read IMPLEMENTATION_ROADMAP.md lines 336-375.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
- compiler/targets/c/EMITTER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 227-247
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 376-412
3. Map: `compiler/driver/DRIVER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 227-247.
Then read IMPLEMENTATION_ROADMAP.md lines 376-412.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/hir/lowering/HIR_LOWERING_MAP.md
- compiler/project/PROJECT_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 248-268
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 413-452
...
Start from IMPLEMENTATION_CHECKLIST.md lines 248-268.
Then read IMPLEMENTATION_ROADMAP.md lines 413-452.
Then open these maps:
- compiler/hir/lowering/HIR_LOWERING_MAP.md
- compiler/project/PROJECT_MAP.md
- compiler/semantic/binder/BINDER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 269-293
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 453-507
3. Map: `compiler/semantic/binder/BINDER_MAP.md`
4. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
5. Map: `compiler/semantic/types/TYPE_SYSTEM_MAP.md`
6. Map: `compiler/targets/c/EMITTER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 269-293.
Then read IMPLEMENTATION_ROADMAP.md lines 453-507.
Then open these maps:
- compiler/semantic/binder/BINDER_MAP.md
- compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md
- compiler/semantic/types/TYPE_SYSTEM_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 294-317
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 508-554
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/hir/lowering/HIR_LOWERING_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 294-317.
Then read IMPLEMENTATION_ROADMAP.md lines 508-554.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/hir/lowering/HIR_LOWERING_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 318-339
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 555-601
3. Map: `compiler/frontend/ast/AST_MAP.md`
4. Map: `compiler/frontend/parser/PARSER_MAP.md`
5. Map: `compiler/hir/lowering/HIR_LOWERING_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 318-339.
Then read IMPLEMENTATION_ROADMAP.md lines 555-601.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
- compiler/hir/lowering/HIR_LOWERING_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 340-357
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 602-646
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 340-357.
Then read IMPLEMENTATION_ROADMAP.md lines 602-646.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/lexer/LEXER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 358-369
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 647-666
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 358-369.
Then read IMPLEMENTATION_ROADMAP.md lines 647-666.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 370-384
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 667-699
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 370-384.
Then read IMPLEMENTATION_ROADMAP.md lines 667-699.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 385-407
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 700-735
3. Map: `compiler/frontend/ast/AST_MAP.md`
4. Map: `compiler/frontend/lexer/LEXER_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/hir/lowering/HIR_LOWERING_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 385-407.
Then read IMPLEMENTATION_ROADMAP.md lines 700-735.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/lexer/LEXER_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 408-416
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 736-760
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 408-416.
Then read IMPLEMENTATION_ROADMAP.md lines 736-760.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 417-436
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 761-790
3. Map: `compiler/frontend/ast/AST_MAP.md`
4. Map: `compiler/frontend/parser/PARSER_MAP.md`
5. Map: `compiler/semantic/binder/BINDER_MAP.md`
6. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 417-436.
Then read IMPLEMENTATION_ROADMAP.md lines 761-790.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
- compiler/semantic/binder/BINDER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 437-452
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 791-809
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 437-452.
Then read IMPLEMENTATION_ROADMAP.md lines 791-809.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 453-467
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 810-838
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/lexer/LEXER_MAP.md`
6. Map: `compiler/frontend/parser/PARSER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 453-467.
Then read IMPLEMENTATION_ROADMAP.md lines 810-838.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/lexer/LEXER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 468-486
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 839-875
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/project/PROJECT_MAP.md`
5. Map: `compiler/semantic/binder/BINDER_MAP.md`
6. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 468-486.
Then read IMPLEMENTATION_ROADMAP.md lines 839-875.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/project/PROJECT_MAP.md
- compiler/semantic/binder/BINDER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 487-498
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 876-902
3. Map: `compiler/semantic/binder/BINDER_MAP.md`
4. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
5. Map: `compiler/semantic/types/TYPE_SYSTEM_MAP.md`
6. Map: `compiler/targets/c/EMITTER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 487-498.
Then read IMPLEMENTATION_ROADMAP.md lines 876-902.
Then open these maps:
- compiler/semantic/binder/BINDER_MAP.md
- compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md
- compiler/semantic/types/TYPE_SYSTEM_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 499-512
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 903-926
3. Map: `compiler/hir/lowering/HIR_LOWERING_MAP.md`
4. Map: `compiler/semantic/binder/BINDER_MAP.md`
5. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 499-512.
Then read IMPLEMENTATION_ROADMAP.md lines 903-926.
Then open these maps:
- compiler/hir/lowering/HIR_LOWERING_MAP.md
- compiler/semantic/binder/BINDER_MAP.md
- compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 513-527
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 927-952
3. Map: `compiler/frontend/ast/AST_MAP.md`
4. Map: `compiler/frontend/parser/PARSER_MAP.md`
5. Map: `compiler/hir/lowering/HIR_LOWERING_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 513-527.
Then read IMPLEMENTATION_ROADMAP.md lines 927-952.
Then open these maps:
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
- compiler/hir/lowering/HIR_LOWERING_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 528-542
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 953-969
...
Start from IMPLEMENTATION_CHECKLIST.md lines 528-542.
Then read IMPLEMENTATION_ROADMAP.md lines 953-969.
Then open these maps:
- runtime/c/RUNTIME_MAP.md
- stdlib/STDLIB_MAP.md
Validate with these tests first:
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 543-552
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 970-994
3. Map: `compiler/hir/lowering/HIR_LOWERING_MAP.md`
4. Map: `compiler/project/PROJECT_MAP.md`
5. Map: `compiler/semantic/binder/BINDER_MAP.md`
6. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 543-552.
Then read IMPLEMENTATION_ROADMAP.md lines 970-994.
Then open these maps:
- compiler/hir/lowering/HIR_LOWERING_MAP.md
- compiler/project/PROJECT_MAP.md
- compiler/semantic/binder/BINDER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 553-569
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 995-1022
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 553-569.
Then read IMPLEMENTATION_ROADMAP.md lines 995-1022.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 570-584
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 1023-1050
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 570-584.
Then read IMPLEMENTATION_ROADMAP.md lines 1023-1050.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 585-606
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 1051-1069
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/project/PROJECT_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 585-606.
Then read IMPLEMENTATION_ROADMAP.md lines 1051-1069.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 607-668
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 1070-1109
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/lexer/LEXER_MAP.md`
6. Map: `compiler/frontend/parser/PARSER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 607-668.
Then read IMPLEMENTATION_ROADMAP.md lines 1070-1109.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/lexer/LEXER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 669-681
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 1110-1136
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/project/PROJECT_MAP.md`
5. Map: `compiler/semantic/binder/BINDER_MAP.md`
6. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 669-681.
Then read IMPLEMENTATION_ROADMAP.md lines 1110-1136.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/project/PROJECT_MAP.md
- compiler/semantic/binder/BINDER_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 682-689
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 1137-1152
3. Map: `compiler/semantic/binder/BINDER_MAP.md`
4. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
5. Map: `compiler/semantic/types/TYPE_SYSTEM_MAP.md`
6. Map: `compiler/targets/c/EMITTER_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 682-689.
Then read IMPLEMENTATION_ROADMAP.md lines 1137-1152.
Then open these maps:
- compiler/semantic/binder/BINDER_MAP.md
- compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md
- compiler/semantic/types/TYPE_SYSTEM_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 690-713
...
Start from IMPLEMENTATION_CHECKLIST.md lines 690-713.
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 714-724
2. Roadmap: no dedicated milestone section; infer scope from checklist + nearby roadmap milestones
3. Map: `compiler/semantic/binder/BINDER_MAP.md`
4. Map: `compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md`
5. Map: `compiler/semantic/types/TYPE_SYSTEM_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 714-724.
Roadmap has no dedicated section for this milestone; infer scope from checklist and adjacent roadmap milestones.
Then open these maps:
- compiler/semantic/binder/BINDER_MAP.md
- compiler/semantic/diagnostics/DIAGNOSTICS_MAP.md
...
1. Checklist: `IMPLEMENTATION_CHECKLIST.md` lines 725-738
2. Roadmap: `IMPLEMENTATION_ROADMAP.md` lines 1153-1170
3. Map: `compiler/driver/DRIVER_MAP.md`
4. Map: `compiler/frontend/ast/AST_MAP.md`
5. Map: `compiler/frontend/parser/PARSER_MAP.md`
6. Map: `compiler/hir/lowering/HIR_LOWERING_MAP.md`
...
Start from IMPLEMENTATION_CHECKLIST.md lines 725-738.
Then read IMPLEMENTATION_ROADMAP.md lines 1153-1170.
Then open these maps:
- compiler/driver/DRIVER_MAP.md
- compiler/frontend/ast/AST_MAP.md
- compiler/frontend/parser/PARSER_MAP.md
