...
def run_hardening_section(suite, results, artifacts_dir):
    ...
    tasks = [
        ...
        ("driver/repl", ROOT / "tests" / "driver" / "test_repl.py", LAYER_TOOLING, 120, {SUITE_PR_GATE, SUITE_NIGHTLY, SUITE_STRESS}),
        ("driver/zpm_lockfile", ROOT / "tests" / "driver" / "test_zpm_lockfile.py", LAYER_TOOLING, 120, {SUITE_PR_GATE, SUITE_NIGHTLY, SUITE_STRESS}),
        ("driver/zpm_semver", ROOT / "tests" / "driver" / "test_zpm_semver.py", LAYER_TOOLING, 120, {SUITE_PR_GATE, SUITE_NIGHTLY, SUITE_STRESS}),
        ("driver/phase5b_examples", ROOT / "tests" / "driver" / "test_phase5b_examples.py", LAYER_TOOLING, 180, {SUITE_PR_GATE, SUITE_NIGHTLY, SUITE_STRESS}),
