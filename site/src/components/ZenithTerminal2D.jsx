...
const TerminalBar = React.memo(({ title }) => (
...
const TerminalFooter = React.memo(({ line, col }) => (
...
const ZenithTerminal2D = () => {
  ...
  return (
    ...
    >
      <TerminalBar title={CODE_SAMPLES[currentSample].title} />
      ...
      <TerminalFooter line={lineIndex + 1} col={typingIndex + 1} />
    </motion.div>
  );
};
