...
- [ ] Lógica de `zpm install`: Download em massa de dependências.
- [ ] Lógica de `zpm info`: Star Profile de pacotes.
- [ ] Lógica de `zpm update`: Sincronia de versões via Git.
- [ ] Lógica de `zpm clean`: Faxina de órbita.
