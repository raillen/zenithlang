...
Ascension continua sendo a linha self-hosted do projeto e consolidou uma leitura oficial precisa e operacionalmente limpa.
...
- a base `.zt` do compilador valida bootstrap canonico sem dependencia de superficie legada;
