...
1. Checklist: secao `R2.M0` em `docs/planning/checklist-v2.md`
2. Roadmap: secao `R2.M0` em `docs/planning/roadmap-v2.md`
3. Docs:
   - `language/spec/conformance-matrix.md`
   - `tests/perf/README.md`
4. Codigo:
...
```text
Implement milestone <R2.Mx> from docs/planning/checklist-v2.md.
Read docs/planning/roadmap-v2.md and docs/planning/cascade-v2.md first.
