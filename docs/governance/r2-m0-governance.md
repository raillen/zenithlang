...
- Quality: `docs/governance/baselines/quality-baseline.json`
- Performance snapshot: `docs/governance/baselines/perf-baseline.json`
...
| Specs and Planning | `language/spec/**`, `docs/planning/**`, `docs/governance/**` | `@raillen` |
...
- Allowed only with explicit risk acceptance file:
  - `docs/reports/overrides/p0-<issue-id>.md`
...
- Latest triage report in `docs/reports/triage/latest.md`
- Frozen quality baseline in `docs/governance/baselines/quality-baseline.json`
- Frozen perf baseline snapshot in `docs/governance/baselines/perf-baseline.json`
