...
A linguagem evita atalhos implicitos quando eles tornam o código mais difícil de revisar.

## Forma básica de um arquivo
...
- Indentacao recomendada: 4 espaços.
...
- `public` significa visibilidade, não global.
- A linguagem não tem sintaxe `global`.
...
Outro namespace não pode escrever:
