...
Manter o registro de fechamento de milestones M0-M38 com rastreabilidade de evidencias.

## Escopo

- Registro historico de implementacao concluida.
- Base de comparacao para ciclos novos.
...
Consulte este checklist para contexto historico. Para novas entregas, trabalhe no checklist v2.

Checklist operacional derivado de `docs/internal/planning/roadmap-v1.md`.

## Cascade Navigation

Para implementar ou auditar um milestone, use `docs/internal/planning/cascade-v1.md` como ponte entre:
...
- Analise profunda concluida em `docs/internal/reports/implementation-deep-analysis.md`.
- Total de milestones: 38 (M0-M38).
- Milestones implementados: 38/38.
- Milestones em aberto: 0.
- Gates de release v1: 10/10 verdes.
## M0. Congelar contratos

- [x] Revisar `language/spec/surface-syntax.md` e marcar claramente o que esta fora do MVP
- [x] Confirmar em doc que API de processo fica fora do primeiro frontend
