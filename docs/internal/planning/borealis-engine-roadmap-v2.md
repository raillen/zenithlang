...
5. o build Tauri copia o SDK para a pasta runtime SDK do app.
...
- resolver SDK pela pasta runtime SDK no app empacotado;
...
- nenhum erro referencia caminhos legados do repo raiz quando o SDK empacotado existe;
