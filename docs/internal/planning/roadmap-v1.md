...
Use este documento como base historica. Para trabalho atual, priorize `docs/internal/planning/roadmap-v2.md`.
...
Para sair do milestone abstrato e chegar nos arquivos, simbolos e testes mais provaveis, use `docs/internal/planning/cascade-v1.md` junto com este roadmap.
...
- API de processo continua fora do primeiro frontend;
...
- links globais em docs/public/guides restritos a simbolos publicos;
