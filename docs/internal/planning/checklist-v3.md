...
Checklist operacional derivado de `docs/internal/planning/roadmap-v3.md`.
...
- `docs/internal/reports/release/R3.M0-kickoff-report.md`
- `docs/internal/reports/R3-risk-matrix.md`
- `docs/internal/reports/R3.M0-borealis-alignment-checkpoint.md`
- `docs/internal/governance/baselines/quality-baseline.json` (congelada 2026-04-21)
- `docs/internal/governance/baselines/perf-baseline.json` (congelada 2026-04-21)
...
- `docs/internal/reports/release/R3.M1-diagnostics-hardening-report.md`
...
- `docs/internal/reports/release/R3.M2-concurrency-base-report.md`
...
- `docs/internal/reports/release/R3.M3-ffi-1.0-report.md`
...
- `docs/internal/reports/release/R3.M4-dyn-dispatch-report.md`
...
- `docs/internal/reports/release/artifacts/zenith-0.3.0-alpha.3-windows-amd64.zip`
- `docs/internal/reports/release/artifacts/zenith-0.3.0-alpha.3-windows-amd64.checksums.txt`
- `docs/internal/reports/release/artifacts/R3.M9-release-artifacts-0.3.0-alpha.3.json`
