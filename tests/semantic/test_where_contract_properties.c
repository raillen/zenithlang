/**
 * R2.M3 - Property Tests para Where Clauses e Contracts
 * 
...
/* Test 2: Where com struct deve falhar */
...
/* Test 3: Múltiplos constraints com AND */
...
/* Test 4: Generic sem constraint usa tipo livremente */
...
/* Test 6: Contract violation - tipo não satisfaz constraint */
static void test_contract_violation_type_mismatch(void) {
    ...
    zt_check_result checked = zt_check_file(parsed.root);
    /* Deve falhar porque text não implementa Addable */
