...
#define OUT_DIR ".ztc-tmp/tests/conformance-m10"
...
int main(void) {
    ...
    test_behavior_project(
        ...
        "tests\\behavior\\control_flow_while\\build\\control-flow-while.exe",
        6,
        "control_flow_while");

    test_behavior_project(
        "tests/behavior/control_flow_repeat",
        "tests\\behavior\\control_flow_repeat\\build\\control-flow-repeat.exe",
        9,
        "control_flow_repeat");

    test_behavior_project(
        "tests/behavior/control_flow_match",
        "tests\\behavior\\control_flow_match\\build\\control-flow-match.exe",
        7,
        "control_flow_match");

    test_behavior_project(
        "tests/behavior/control_flow_break_continue",
        "tests\\behavior\\control_flow_break_continue\\build\\control-flow-break-continue.exe",
        8,
        "control_flow_break_continue");

    test_behavior_project(
        "tests/behavior/control_flow_for_list",
        "tests\\behavior\\control_flow_for_list\\build\\control-flow-for-list.exe",
        13,
        "control_flow_for_list");

    test_behavior_project(
        "tests/behavior/control_flow_for_map",
        "tests\\behavior\\control_flow_for_map\\build\\control-flow-for-map.exe",
        6,
        "control_flow_for_map");

    printf("M10 conformance tests: %d/%d passed\n", tests_passed, tests_run);
