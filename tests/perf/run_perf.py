...
def bench_specs():
    return [
        ...
        {"id": "micro_algorithm_core", "scenario": "micro_algorithm", "cat": "runtime", "kind": "bin", "project": ROOT / "tests" / "perf" / "micro_algorithm_core", "expect": "micro-algorithm-core-ok", "iters": {"quick": 2, "nightly": 5}, "budget": {"warn": {"lat_median_ms": 2500, "lat_p95_ms": 3800, "startup_ms": 2500, "peak_ws": 360_000_000}, "fail": {"lat_median_ms": 6500, "lat_p95_ms": 9000, "startup_ms": 6500, "peak_ws": 700_000_000}}, "suites": ["quick", "nightly"]},
