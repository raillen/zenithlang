...
1. Checklist: secao `R2.M0` em `IMPLEMENTATION_CHECKLIST_2_0.md`
2. Roadmap: secao `R2.M0` em `IMPLEMENTATION_ROADMAP_2_0.md`
3. Docs:
   - `language/spec/conformance-matrix.md`
   - `tests/perf/README.md`
4. Codigo:
...
```text
Implement milestone <R2.Mx> from IMPLEMENTATION_CHECKLIST_2_0.md.
Read IMPLEMENTATION_ROADMAP_2_0.md and IMPLEMENTATION_CASCADE_2_0.md first.
